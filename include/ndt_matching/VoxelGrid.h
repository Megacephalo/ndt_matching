#ifndef NDT_MATCHING__VOXELGRID_H
#define NDT_MATCHING__VOXELGRID_H
...
private:
	...
	std::shared_ptr<std::vector<Eigen::Vector3d> > centroid_;			// 3x1 Centroid vectors of voxels
	// boost::shared_ptr<std::vector<Eigen::Matrix3d> > icovariance_;		// Inverse covariance matrixes of voxel
	std::shared_ptr<std::vector<Eigen::Matrix3d> > icovariance_;		// Inverse covariance matrixes of voxel
	// boost::shared_ptr<std::vector<std::vector<int> > > points_id_;		// Indexes of points belong to each voxel
	std::shared_ptr<std::vector<std::vector<int> > > points_id_;		// Indexes of points belong to each voxel
	// boost::shared_ptr<std::vector<int> > points_per_voxel_;				// Number of points belong to each voxel
	std::shared_ptr<std::vector<int> > points_per_voxel_;				// Number of points belong to each voxel
	...
	std::shared_ptr<std::vector<Eigen::Vector3d> > tmp_centroid_;
	// boost::shared_ptr<std::vector<Eigen::Matrix3d> > tmp_cov_;
	std::shared_ptr<std::vector<Eigen::Matrix3d> > tmp_cov_;
...
#endif // NDT_MATCHING__VOXELGRID_H