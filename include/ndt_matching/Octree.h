#ifndef NDT_MATCHING__OCTREE_H_
#define NDT_MATCHING__OCTREE_H_
...
private:
	...
	std::shared_ptr<std::vector<std::vector<OctreeNode> > > octree_;
	// boost::shared_ptr<std::vector<OctreeLevelBoundaries> > reserved_size_;
	std::shared_ptr<std::vector<OctreeLevelBoundaries> > reserved_size_;
	// boost::shared_ptr<std::vector<OctreeLevelDim> > dimension_;
	std::shared_ptr<std::vector<OctreeLevelDim> > dimension_;
	...
	std::shared_ptr<std::vector<std::vector<unsigned int> > > occupancy_check_;
